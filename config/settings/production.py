...
# AWS_ACCESS_KEY_ID = env("DJANGO_AWS_ACCESS_KEY_ID", "AWS_ACCESS_KEY_IDlocal")
# https://django-storages.readthedocs.io/en/latest/backends/amazon-S3.html#settings
# AWS_SECRET_ACCESS_KEY = env("DJANGO_AWS_SECRET_ACCESS_KEY", 'test')
# https://django-storages.readthedocs.io/en/latest/backends/amazon-S3.html#settings
# AWS_STORAGE_BUCKET_NAME = env("DJANGO_AWS_STORAGE_BUCKET_NAME", 'test')
# https://django-storages.readthedocs.io/en/latest/backends/amazon-S3.html#settings
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Web Forms <noreply@example.com>",
)
